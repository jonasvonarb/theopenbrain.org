...
<template>
  ...
  >
    ...
    <InteractionButton
      ...
      :text="'close'"
      :target="'Menu'"
      class="absolute bg-bgDa pt-4 pb-4 pointer-events-auto z-[60] h-full w-[3.15rem] flex justify-center items-start top-0 right-0 duration-300 overflow-hidden"
    />
    <!-- menu open/close chapter -->
    <InteractionButton
      :text="'open'"
      :target="'Menu'"
      class="fixed bg-bgDa pt-4 pb-4 pointer-events-auto z-[60] h-full w-[3.15rem] flex justify-center items-start top-0 duration-300 overflow-hidden"
      :class="
